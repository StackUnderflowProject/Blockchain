...
mpirun --oversubscribe -np "$NUM_OF_PROCESSES" "$PROGRAM_PATH" "$DIFFICULTY" "$DATA" "$EXPECTED_TIME" "$NUM_OF_THREADS_PER_WORKER" "$EXPECTED_NUM_OF_BLOCKS"
